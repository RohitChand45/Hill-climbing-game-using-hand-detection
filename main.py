...
from pynput.keyboard import Key, Controllerpip
...
fingerTipIds = [4, 8, 12, 16, 20] #The fingerTipIds variable contains a list of numbers that correspond to specific points on a hand.
#these points pointed at the tips of each finger except the thumb
